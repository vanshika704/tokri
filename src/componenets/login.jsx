...
function Login (){
    ...
    const _handelbuttonclick = () => {
        navigate('/Page1');  // Navigates to the About page
      };
       ...
       <div className="max-w-[280px] mx-auto">
        <div className="flex flex-col items-center mt-[10vh]">
            ...
            <form>
                ...
                <button className="bg-slate-500 hover:bg-slate-700 text-white text-base rounded-lg py-2.5 px-5 transition-colors w-full text-[19px]" onClick={_handelbuttonclick}>Log In</button>
            </form>
